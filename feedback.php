...
<body>
    ...
    <div class="bg1">
        <div class="row">
            ...
            <div class="col-md-6 panel" style="background:#202020; min-height:430px; 
            box-shadow:5px 5px 20px 6px;">
                <h2 align="center" style="font-family:'typo'; color:#000066"><span
                        style="border-bottom:2px groove #ffa500; color:#ffa500;">FEEDBACK / REPORT A PROBLEM</span></h2>
                <div style="font-size:14px">
                    <?php if (@$_GET['q']) echo '<span style="font-size:18px;"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;' . @$_GET['q'] . '</span>';
                    else {
                        echo ' 
<center><p style="color:white;">You can send us your feedback through e-mail on the following e-mail id:</p></center><br />
<div class="row">
<div class="col-md-1"></div>
<div class="col-md-10">
<center>
    <a href="mailto:chiraggoel.53784@gmail.com" style="color:white;">abhi588777@gmail.com</a><br /><br />
</center>
</div><div class="col-md-1"></div></div>
<p><center><b  style="color:white;">Or you can directly submit your feedback by filling the enteries below:-</b></center></p>
<form role="form"  method="post" action="feed.php?q=feedback.php" style="color:white;">
    ...
    <div class="row mt-5 footer">
        ...
        <div class="row text-light" style="background: rgba(0,0,0,0.4);">
            <div class="col-sm-3 text-light">
                <center>
                    <img src="qr_quizz.png" style="height: 200px; width:200px; padding:10px;">
                </center>
            </div>
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3606.8855106355313!2d83.05473771468596!3d25.308050383844737!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x398e30203b37db8b%3A0xab141428b11aaaeb!2sAmbition%20Institute%20of%20Technology%20(Best%20Polytechnic%20College%20%26%20Fashion%20Designing%20Institute%20Varanasi)!5e0!3m2!1sen!2sin!4v1650129707659!5m2!1sen!2sin"
                    width="200" height="180" style="border:1px solid orange; margin-top:10px; border-radius:5px;"
                    allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <div class="col-sm-3">
                <h3><b style="color:white">CONTACT</b></h3>
                <h5 style="color: green;">
                    GL BAJAJ, Gr. Noida, UP, India
                </h5>
                <h5 style="color: green;">
                    E-mail : abhi588777@gmail.com
                </h5>
                <h5 style="color: green;">Mob No : +91-9696063201</h5>
                <h5 style="color: green;">
                    Linkedin : Bhanu Shukla
                </h5>
            </div>
            <!-- Modal For About Us-->
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" style="font-family:'typo' "><span
                                    style="color:orange;font-size:35px; border-bottom:1px solid black;">About Us</span>
                            </h4>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4" style="margin-left:20px;">
                                    <img src="qr_quizz.png" width=170 height=170 alt="BSH Team" class="img-rounded"
                                ...
                                <div class="col-md-5" style="margin-left:40px; margin-top: -25px;">
                                    <a href="#" style="color:#202020;  font-family:'typo' ; font-size:18px"
                                        ...
                                        <h3><span style="border-bottom:2px solid #202020;">QuizzHub Website</span></h3>
                                    </a>
                                    <b style="color:#202020; font-family:'typo' ;font-size:16px ;text-align:justify;"
                                        class="title1">
                                        These is a Quiz Platform website where every user can test its skills.
                                        There are different - different Subjects which user can choose it and give a
                                        test
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-4" style="margin-left:20px;">
                                    <img src="image/bhanu.jpg" width=150 height=200 alt="BSH Team" class="img-rounded"
                                        style="margin-top: -20px;">
                                </div>
                                <div class="col-md-5" style="margin-left:40px;">
                                    <a href="#" style="color:#202020; font-family:'typo' ; font-size:18px"
                                        title="Find on Facebook">Bhanu Pratap Shukla</a>
                            ...
                            <div class="row" style="padding-top:40px;margin-left:40px;">
                                <div class="col-md-4">
                                    <a href="#" style="color:#202020; font-family:'typo' ; font-size:18px"
                                        title="Find on Facebook">Shreya Vishwakarma</a>
                                    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">
                                        +91-9325398180</h4>
                                ...
                                <div class="col-md-5" style="margin-left:40px;">
                                    <img src="image/shreya.jpg" width=150 height=200 alt="BSH Team" class="img-rounded"
                                        style="margin-top: -20px;">
                                </div>
                            </div>
                            <div class="row" style="padding-top:40px;margin-left:20px;">
                                <div class="col-md-4">
                                    <img src="image/harsh.jpg" width=150 height=200 alt="BSH Team" class="img-rounded"
                                        style="margin-top: -20px;">
                                </div>
                                <div class="col-md-5" style="margin-left:40px;">
                                    <a href="#" style="color:#202020; font-family:'typo' ; font-size:18px"
                                        title="Find on Facebook">Harsh Chaubey</a>
                                    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">
                                        +91-9506213820</h4>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal"><span
                                    aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                            <h4 class="modal-title"><span style="color:orange;font-family:'typo' "><b
                                        style="font-size:30px;">LOGIN</b></span></h4>
                        </div>
                                    ...
                                    <form role="form" method="post" action="admin.php?q=index.php">
                                        <div class="form-group">
                                            <input type="text" name="uname" maxlength="20" placeholder="Admin user id"
                                                class="form-control"
                                                style="background:rgba(0,0,0,0.6); color:white; border:none; border-bottom:2px solid white;">
                                        </div>
                                        <div class="form-group">
