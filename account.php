...
<body>
    <div class="header">
        <div class="row">
            <div class="col-lg-6">
                <span class="logo"><b style="margin-top:10px; font-size:35px;">Test Your Skill</b></span>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="account.php?q=3"><span
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5" style="margin-left:40px;">
                                    ...
                                    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">
                                        +91-9696023201</h4>
                                    <h4 style="font-family:'typo' ">abhi588777@gmail.com</h4>
                                    <h4 style="font-family:'typo' ">
                                        GL BAJAJ, INSTITUTE OF TECHNOLOGY AND MANAGEMENT, GR. NOIDA, UP, INIDA
                                    </h4>
                                </div>
                            </div>
                            </p>
